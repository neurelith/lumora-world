...
export default function DoctorHubPage() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-paper flex flex-col justify-between p-4 md:p-8">
        ...
        <main id="main-content" className="max-w-md mx-auto w-full py-12">
          <Card variant="elevated" className="p-7 md:p-10 bg-white border-black/10 shadow-[0_18px_46px_rgba(0,0,0,0.11)] space-y-7">
            <div className="space-y-3">
              <div className="w-11 h-11 bg-[#1d1d1f] text-white rounded-xl flex items-center justify-center">
                <Lock className="w-5 h-5" />
              </div>
              <p className="text-[13px] font-semibold tracking-[0.08em] text-amber">LUMORA CLINICAL VIEW</p>
              <h1 className="text-[30px] leading-none tracking-[-0.05em] font-display font-semibold text-ink">Specialist Hub</h1>
              <p className="text-sm text-muted font-body leading-6">A focused workspace for reviewing pseudonymous learning signals and planning next steps.</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-paper border-2 border-hairline rounded-xl px-3.5 py-2.5 text-sm font-body text-ink focus:outline-none focus:border-castle"
                    required
                  />
                  <UserCheck className="w-4 h-4 text-muted absolute right-3.5 top-3" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                  />
                  <KeyRound className="w-4 h-4 text-muted absolute right-3.5 top-3" />
                </div>
              </div>
            ...
            <div className="pt-2 border-t border-hairline text-center space-y-2">
              ...
              <button
                type="button"
                onClick={() => handleLogin()}
                className="w-full py-2 px-3 bg-cream border border-amber/40 rounded-xl text-xs font-display font-bold text-amber-900 hover:bg-amber-100 transition-colors cursor-pointer"
              >
                ✨ Quick Access as Dr. Ananya Sharma (Clinical Psychologist)
              </button>
            </div>

            <div className="p-3 bg-paper rounded-xl text-[11px] text-muted font-body leading-relaxed flex items-start gap-2">
        ...
        <footer className="max-w-5xl mx-auto w-full text-center text-xs text-muted font-body py-4">
  ...
  return (
    <div className="min-h-screen bg-paper p-4 md:p-8">
      ...
      <header className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-6 border-b-2 border-hairline">
        <div className="flex items-center gap-3">
          <Link href="/" className="p-2.5 bg-white border border-hairline rounded-2xl text-ink hover:text-amber transition-colors">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="bg-sage/20 text-sage-800 text-xs font-bold px-2.5 py-0.5 rounded-full border border-sage/30 flex items-center gap-1">
                  <CheckCircle2 className="w-3.5 h-3.5" /> Authenticated
                </span>
              </div>
              <p className="text-xs font-body text-muted">
                {t('doctor.subtitle')} · Logged in as <strong className="text-ink">{doctorLicense}</strong>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center bg-white border-2 border-hairline rounded-2xl p-1 shadow-soft-sm">
            <button
              ...
              className={`px-3 py-1.5 rounded-xl font-display text-xs md:text-sm font-bold transition-all cursor-pointer ${
                activeTab === 'roster' ? 'bg-castle text-white shadow-soft-sm' : 'text-muted hover:text-ink'
              }`}
            >

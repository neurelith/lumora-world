      ...
      <div className={`fixed bottom-5 right-5 z-50 flex flex-col items-end gap-2 ${className}`}>
        {!isActive ? (
          <button
            ...
            disabled={isStarting}
            className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-ink text-amber hover:bg-ink/90 border border-amber/30 shadow-soft-lg transition-all active:scale-95 font-display font-bold text-xs"
          >
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-2 rounded-full bg-white border border-hairline text-ink hover:bg-sand/60 shadow-soft-xs"
